...
const Answer: FC<AnswerProps> = ({
  ...
  index,
  choice,
  type = 'MCQs', // Default type set to 'MCQs'
  selectedAnswer
}) => {
  const label = String.fromCharCode(65 + index); // Convert index to alphabet character

  return (
    <AnswerStyle highlightAnswer={selectedAnswer.includes(choice)}>
      <AnswerLabel>

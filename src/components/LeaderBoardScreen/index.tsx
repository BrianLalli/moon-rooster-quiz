...
const LeaderboardHeading = styled.h2`
  ...
  text-align: center;
  color: ${({ theme }) =>
    theme.colors.primaryText}; /* Use the primaryText color from the theme */
`
...
const Leaderboard: React.FC = () => {
  ...
  return (
    <PageCenter light justifyCenter style={{ width: '100%', borderRadius: '25px' }}>
      {' '}
      <CenterCardContainer style={{ width: '50%', borderRadius: '25px' }}>
